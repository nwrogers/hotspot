...
MainWindow::MainWindow(QWidget *parent) :
    ...
    m_LoadingResultsMovie(new QMovie(":/images/loading_icon.gif"))
{
    ui->setupUi(this);
    ui->mainToolBar->hide();
    ...
    ui->loadingIcon->setMovie(m_LoadingResultsMovie);
    hideLoadingResults();
